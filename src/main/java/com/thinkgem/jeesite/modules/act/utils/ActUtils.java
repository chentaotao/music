...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_TEST_AD = new String[]{"test_ad", "oa_test_ad"};
	public static final String[] PD_MUSIC_APPROVE = new String[]{"music_approve", "oa_music_approve"};
