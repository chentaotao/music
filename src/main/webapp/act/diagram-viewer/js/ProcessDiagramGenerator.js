...
var ProcessDiagramGenerator = {	
	...
	drawHighLights: function(processInstanceId) {
		...
		*/
		// ���������ʵ����ʱ���׳��쳣���⡣
		var url = Lang.sub(ActivitiRest.options.processInstanceUrlNew, {processInstanceId: processInstanceId});
		console.log("ctt url:"+url);
        console.log("ctt url 1:"+ActivitiRest.options.processInstanceUrlNew);
